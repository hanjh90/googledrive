            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="processings"
                        to="/videoProcessings/processings"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'processings', 
                route: '/videoProcessings/processings',
                ImageUrl: '',
            },
            { 
                title: 'Noti', 
