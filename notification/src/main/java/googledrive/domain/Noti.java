...
public class Noti {
    ...
    public static void fileUpload(FileUploaded fileUploaded) {
        ...
        */
        ...
        repository().findById(fileUploaded.get???()).ifPresent(noti->{
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void videoCreate(FileProcessed fileProcessed) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(fileProcessed.get???()).ifPresent(noti->{
